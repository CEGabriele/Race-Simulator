...
const courseDistances = {
    ...
    "Dual County Leagues": 3.1,
    "Old Colony Leagues": 3.1,
    "Falmouth": 3.1,
    "Ocean State": 3.1,
    "Battle of Border": 3.1,
    "Brockton": 3.1,
    "Hockomock League Meet": 3.1,
    "Bay State": 3.1,
    "Bay State Conference": 3.1,
    "Patriot Leagues": 3.1,
    "Ted Dutkiewicz Memorial": 3.1,
    "North Division": 3.1,
    "Newton": 3.1,
    "Hanson": 3.1,
    "Big 3 League Meet": 3.1,
    Diman: 3.1,
    "King Philip":3.1
...
function generateTable(data) {
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        row.classList.add(`team-${slugifyTeamName(data[i][4])}`);
